 ...
 */
 ...
 #define RGB_GRAY 0xFF808080
 #define RGB_RED 0xFFFF0000
 #define RGB_ORANGE 0xFFFFA500
 #define RGB_GREEN 0xFF008000
 #define RGB_BLUE 0xFF0000FF
 #define RGB_SILVER 0xFFC0C0C0
 #define RGB_BROWN 0xFFA52A2A
 #define RGB_CYAN 0xFF00FFFF
 #define RGB_CERISE 0xFFDE3163
 #define RGB_YELLOW 0xFFFFFF00
 #define RGB_GOLDEN 0xFFFFD700
 #define RGB_VERMILION 0xFFFF4D00
